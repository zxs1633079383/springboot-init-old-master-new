...
import static com.zlc.project.constant.UserConstant.ADMIN_ROLE;
import static com.zlc.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String seterKey = DigestUtil.md5Hex(SALT + userAccount + RandomUtil.randomNumbers(8));;

            // 4. 插入数据
            User user = new User();
            user.setAccessKey(accessKey);
            user.setSecreKey(seterKey);
